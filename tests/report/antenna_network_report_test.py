    ...
    def test_network_report_uses_all_antennas(self):
        with application.app_context():
            ...
            antenna_network_report_expected = [
                {'carrier_id': 1, 'network_type': 1, 'antenna_id': 1, 'size': 1},
                {'carrier_id': 1, 'network_type': 2, 'antenna_id': 1, 'size': 1},
                {'carrier_id': 2, 'network_type': 1, 'antenna_id': 2, 'size': 1},
                {'carrier_id': 2, 'network_type': 1, 'antenna_id': 3, 'size': 2}]
